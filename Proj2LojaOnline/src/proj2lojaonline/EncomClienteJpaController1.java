 ...
 * @author marci
 */
public class EncomClienteJpaController1 implements Serializable {

    public EncomClienteJpaController1(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(EncomCliente encomCliente) {
