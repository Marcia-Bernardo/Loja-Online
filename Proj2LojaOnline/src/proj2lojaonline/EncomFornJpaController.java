 ...
 * @author marci
 */
public class EncomFornJpaController implements Serializable {

    public EncomFornJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(EncomForn encomForn) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findEncomForn(encomForn.getCodencforn()) != null) {
                throw new PreexistingEntityException("EncomForn " + encomForn + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
