 ...
 * @author marci
 */
public class MoradaDeEntregaJpaController implements Serializable {

    public MoradaDeEntregaJpaController(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(MoradaDeEntrega moradaDeEntrega) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findMoradaDeEntrega(moradaDeEntrega.getCodmoradaentr()) != null) {
                throw new PreexistingEntityException("MoradaDeEntrega " + moradaDeEntrega + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
