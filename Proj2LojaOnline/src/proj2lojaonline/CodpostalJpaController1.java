 ...
 * @author marci
 */
public class CodpostalJpaController1 implements Serializable {

    public CodpostalJpaController1(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public void create(Codpostal codpostal) {
